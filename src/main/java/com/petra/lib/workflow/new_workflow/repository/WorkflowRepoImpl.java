...
public class WorkflowRepoImpl implements WorkflowRepo {
    ...
    @Override
    public void setNodeExecuted(UUID scenarioId, Long workflowId, Long nodeId,  Collection<ProcessVariable> resultVariables) throws JsonProcessingException {
    ...
    @Override
    public Collection<ProcessVariable> getNodeExecutionResults(UUID scenarioId, Long workflowId, Long nodeId) throws JsonProcessingException {
        ...
        return om.readValue(values, new TypeReference<Collection<ProcessVariable>>() {});
    }
