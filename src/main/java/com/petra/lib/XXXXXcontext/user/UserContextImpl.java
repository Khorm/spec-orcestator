package com.petra.lib.XXXXXcontext.user;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.petra.lib.PetraException;
import com.petra.lib.XXXXXcontext.DutryContextImpl;
...
public class UserContextImpl implements UserContext, VariableContext {
    ...
    public <T> T getExecutionVariable(String variableName, Class<T> clazz){
        ...
        ProcessValue processValue = context.getVariableById(pureVariableList.getVariableByName(variableName).getId());
        T var;
        try {
    ...
    public DutryContextImpl fillContext(){
        valuesCache.forEach((key, value) -> {
            StatelessVariable statelessVariable = pureVariableList.getVariableByName(key);
            try {
