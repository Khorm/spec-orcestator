...
import com.petra.lib.block.switcher.StateSwitchStrategy;
...
class BlockImpl implements Block {
     ...
     */
    StateSwitchStrategy stateSwitchStrategy;
    ...
    public void execute(ActivityContext activityContext) {
        ActionState actionState = stateSwitchStrategy.getNextHandler(activityContext);
