...
//    }
    ...
    public void execute(ActionContext context) throws Exception {
        transactionManager.executeInTransaction(jpaTransactionManager -> {
            ...
            actionRepo.updateActionContextVariables(context.getScenarioId(), context.getActionId(), context.getActionVariables());

            context.setNewState(ActionState.EXECUTED);
            actionRepo.updateActionStatus(context.getScenarioId(), context.getActionId(), context.getActionState());
        });
    }
