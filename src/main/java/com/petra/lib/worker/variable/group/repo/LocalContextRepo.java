...
class LocalContextRepo implements ContextRepo {
    ...
    @Override
    public synchronized JobContext getExecutionContext(UUID scenarioId, Long blockId) {
    ...
    @Override
    public synchronized Set<Long> setExecution(JobContext context, Long groupId) {
